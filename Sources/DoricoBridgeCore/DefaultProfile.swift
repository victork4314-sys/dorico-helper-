...
public enum DefaultCatalog {
    public static let actions: [ActionDescriptor] = {
        ...
        add("popover.dynamics", "Dynamics popover", "Popovers", "Default Dorico Pro command Shift-D", .keyChord(KeyChord("d", modifiers: [.shift])))
        add("popover.ornaments", "Ornaments popover", "Popovers", "Default Dorico Pro command Shift-O", .keyChord(KeyChord("o", modifiers: [.shift])))
        add("popover.meter", "Time signature popover", "Popovers", "Default Dorico Pro command Shift-M", .keyChord(KeyChord("m", modifiers: [.shift])))
        add("popover.key", "Key signature popover", "Popovers", "Default Dorico Pro command Shift-K", .keyChord(KeyChord("k", modifiers: [.shift])))
        add("popover.tempo", "Tempo popover", "Popovers", "Default Dorico Pro command Shift-T", .keyChord(KeyChord("t", modifiers: [.shift])))
        add("popover.clef", "Clef popover", "Popovers", "Default Dorico Pro command Shift-C", .keyChord(KeyChord("c", modifiers: [.shift])))
        add("popover.playing", "Playing techniques popover", "Popovers", "Default Dorico Pro command Shift-P", .keyChord(KeyChord("p", modifiers: [.shift])))
        add("popover.bars", "Bars and barlines popover", "Popovers", "Default Dorico Pro command Shift-B", .keyChord(KeyChord("b", modifiers: [.shift])))
    ...
    public static let legatoStyleProfile: ControllerProfile = {
        ...
        bind(.bothTriggers, .buttonA, "popover.dynamics")
        bind(.bothTriggers, .buttonB, "popover.ornaments")
        bind(.bothTriggers, .buttonX, "popover.meter")
        bind(.bothTriggers, .buttonY, "popover.key")
        bind(.bothTriggers, .dpadUp, "popover.tempo")
        bind(.bothTriggers, .dpadDown, "popover.clef")
        bind(.bothTriggers, .dpadLeft, "popover.playing")
        bind(.bothTriggers, .dpadRight, "popover.bars")
